$(document).ready(function() {
    ...
    $('#run_local_storage_test').on('click', function() {
        ...
        for (i = 1; i <= insert_nb; i++) {
            localStorage_test.insert(i + '@a.a', 'test_rows', 'name', 'surname', '07/07/01', 'homme', 175, 60, 'blablabla')
        }
        ...
        while (!is_full) {
            try {
                localStorage_test.insert(insertion + '@a.a', 'name', 'surname', '07/07/01', 'homme', 175, 60, 'blablabla')
            } catch (e) {
